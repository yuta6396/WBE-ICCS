...
"""
acq_func = "EI"
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAinitial_design_numdata_vec = [5] #BOのRS回数
init_point_generater = "halton"

base_dir = f"ICCS_result/BO/{acq_func}_{init_point_generater}{initial_design_numdata_vec[0]}_{input_var}_seed={trial_base}-{trial_base+trial_num -1}_{current_time}/"
